...
function Category(){
    ...
    const addNewPro = () => {
        ...
        categoryService.addCategory(newPro)
        .then((res) => {
            console.log(`res: ${res}`)
            Swal.fire({
                position: 'top-center',
    ...
    return (
        ...
        <div className="modal fade" id="addCategory" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                ...
                <h5 className="modal-title" id="exampleModalLabel">Thêm Doanh Mục</h5>
                     <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div className="modal-body">
                     <div>
                         <label htmlFor='doanhMuc' className='d-block'>Tên Doanh Mục</label>
                         <input id='doanhMuc' type='text' className='w-100'  maxLength="50"
                     ...
                     <div className='mt-4'>
                         <label htmlFor='descr' className='d-block'>Mô tả</label>
                        <textarea id='descr' className='w-100' rows='6'
                        value={categoryDescription === undefined ? '' : categoryDescription}
                        onChange={(e) => {
