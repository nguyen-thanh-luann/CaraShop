      ...
      <Header />
      {
        ...
        <div>
          ...
          <section className='row mt-5 mx-0 cartDetail'>
            ...
            <h3>Giỏ hàng</h3>
              <table className='table text-center align-baseline'>
                  <thead>
                    <tr>
                      <td></td>
                      <td>Hình Ảnh</td>
                  ...
                  <tbody>
                  {
                    ...
                    <tr key={e.id}>
                      ...
                      <td>
                        <img src={e.imageUrl} className='img-fluid rounded' style={{width: '70px'}} alt='' />
                      </td>
                      <td>{e.productName}</td>
                      <td>{`${vndFormat.format(e.price)}đ`}</td>
                      <td>
                      <input type='number' defaultValue='1' min='1'  style={{width: '4rem'}}
                        onChange={(event) =>{
                ...
                <div className='mt-4'>
                  ...
                  <div>
                    ...
                    <div className='d-flex justify-content-between align-baseline mt-2'>
                      <span><input className='p-1' placeholder='Mã giảm giá'/></span>
                      <span><button className='p-1'>Áp dụng</button></span>
                    </div>
                  ...
                  <div className='d-flex justify-content-between'>
                    <span>Tổng tiền</span>
                    <span className='text-danger fw-bold'>{`${vndFormat.format(totalPrice)}đ`}</span>
                  </div>
